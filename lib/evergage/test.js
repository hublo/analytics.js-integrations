...
describe('Evergage', function(){
  ...
  describe('#identify', function(){
    ...
    it('should send an id and traits', function(){
      ...
      .called(window._aaq.push)
      .args(['setUserField', 'trait', true, 'page'])
      .called(window._aaq.push)
      .args(['setUser', 'id']);
    });
    ...
    it('should send an email', function(){
      ...
      .called(window._aaq.push)
      .args(['setUserField', 'userEmail', 'name@example.com', 'page'])
      .called(window._aaq.push)
      .args(['setUser', 'id']);
    });
    ...
    it('should send a name', function(){
      ...
      .called(window._aaq.push)
      .args(['setUserField', 'userName', 'name', 'page'])
      .called(window._aaq.push)
      .args(['setUser', 'id']);
    });
  });
  ...
  describe('#group', function(){
    ...
    it('should send an id and properties', function(){
      ...
      .called(window._aaq.push)
      .args(['setAccountField', 'property', true, 'page'])
      .called(window._aaq.push)
      .args(['setCompany', 'id'])
    });
  });
  ...
  describe('#track', function(){
    ...
    it('should send an event and properties', function(){
      ...
      .called(window._aaq.push)
      .args(['trackAction', 'event', { property: true }]);
    });
  });
  ...
  describe('#page', function(){
    ...
    it('should send page properties', function(){
      ...
      .args(['namePage', 'name'])
      .called(window._aaq.push)
      .args(['setCustomField', 'property', true, 'page']);
    });
  });
